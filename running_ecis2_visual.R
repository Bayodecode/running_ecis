...
#Trying out the ecis functions

# 1) Import dataset
RES1 <- getECIS2("/Users/bayodeibironke/Downloads/Classical.xlsx")
...
plotECIS(RES1.2, style = "matrix", legend = TRUE) # => 3 plots

# 4) We could give each plot a different color
plotECIS(RES1.2, style = "matrix", legend = TRUE, col = rainbow(3)) # => 3 plots
